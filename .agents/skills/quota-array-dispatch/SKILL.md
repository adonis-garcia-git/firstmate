...
`AGENTS.md` section 4 owns the always-loaded intake boundary, routing precedence, load trigger, and malformed-config refusal; this skill owns everything about choosing within a matched array, including every-candidate accounting, the strongest-reasoning floor, and ties.
