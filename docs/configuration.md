...
FM_GUARD_GRACE=300      # beacon freshness threshold, in seconds of awake time (time the system spent asleep never counts), for guard verdicts, arm health checks, and the primary turn-end guard; see docs/turnend-guard.md for model-aware exceptions
