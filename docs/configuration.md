...
FM_BUSY_REGEX=          # optional override for the remaining rendered-text matchers (Grok's isolated busy-state fallback, the submit acknowledgement, and the supervisor-pane read); converted adapters read semantic state and ignore it
