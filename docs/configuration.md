...
FM_BUSY_REGEX=          # optional override for Grok's isolated busy-state fallback and the submit acknowledgement; converted adapters read semantic state and ignore it
