...
| `fm-supervise-daemon.sh` | Presence-gated away-mode sub-supervisor: self-handle routine wakes, inject only on exact semantic idle, escalate batched digests, alert on failed delivery |
