...
# Both thresholds measure the beacon's awake-time age
# (fm_path_age_since_system_wake), so a beacon that merely predates a system
# sleep window is neither refused nor evicted.
