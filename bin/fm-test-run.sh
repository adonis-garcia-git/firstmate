...
family_for_basename() {
  case "$1" in
    ...
    fm-test-run.test.sh|fm-test-isolation-proof.test.sh|fm-test-toolpath.test.sh)
      printf '%s\n' pure-contract-unit
      ;;
    fm-daemon.test.sh|fm-decision-wait.test.sh|fm-guard-stale-banner.test.sh|\
    fm-pi-watch-extension.test.sh|\
    fm-session-lock-ancestry.test.sh|fm-cursor-primary.test.sh|\
    fm-supervision-events.test.sh|fm-turnend-guard.test.sh|fm-wake-daemon-lifecycle-e2e.test.sh|\
    fm-wake-drain-unread-status.test.sh|\
    fm-tool-update-check.test.sh|fm-dispatch-pickup.test.sh|\
    ...
    fm-control-herdr-smoke.test.sh|fm-spawn-pool-slot-ownership.test.sh)
      printf '%s\n' real-herdr-gated
      ;;
    ...
    fm-pr-reconcile.test.sh|fm-pr-reviewers.test.sh|fm-pr-state.test.sh|\
...
tests/fm-dispatch-pickup.test.sh 7784
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-agent-process-lib.sh)
      ...
      printf '%s\n' pure-contract-unit
      ;;
    bin/fm-watch*|bin/fm-wake*|bin/fm-decision-wait.sh|bin/fm-inactive-reconcile.sh|\
