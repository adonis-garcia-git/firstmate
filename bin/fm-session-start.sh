...
#                       handoff retry, X-mode artifact writes, fleet sync, and the
#                       recorded-PR reconcile sweep) also run only when
...
# recorded-PR reconcile sweep - are
...
#             artifact writes, the recorded-PR reconcile sweep) - and
